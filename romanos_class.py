...
class NumeroRomano:
    ...
    # Sumar 2 valores que el primero no este en NumeroRomano
    def __radd__(self, otro):
        if isinstance(otro, int):
            return NumeroRomano(self.valor + otro)

        # Enviamos a la funcion de suma.
        # return self.__add_(otro)    
    ...
    def __sub__(self,otro):
        if isinstance(otro, NumeroRomano):
            ...
            return NumeroRomano(self.valor - otro)
    # Restar 2 valores que el primero no este en NumeroRomano
    ...
    def __mul__(self, otro):
        if isinstance(otro, NumeroRomano):
            ...
            return NumeroRomano(self.valor * otro)   
    # Multiplicar 2 valores que el primero no este en NumeroRomano
    ...
    def __floordiv__(self, otro): 
        if isinstance(otro, NumeroRomano):
            ...
            return NumeroRomano(self.valor // otro) 
    # Dividir 2 valores que el primero no este en NumeroRomano
    ...
    #Retorna la expresión de representación    
    def __repr__(self):
